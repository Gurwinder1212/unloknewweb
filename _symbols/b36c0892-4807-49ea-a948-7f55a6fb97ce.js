// Site Header - Investor - Updated June 3, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			if (!src_url_equal(img1.src, img1_src_value = /*hero_image_2*/ ctx[3].url)) attr(img1, "src", img1_src_value);
			attr(img1, "alt", img1_alt_value = /*hero_image_2*/ ctx[3].alt);
			attr(div2, "class", "hero-feature-container svelte-517vep");
			attr(div3, "class", "hero-wrapper svelte-517vep");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*hero_image_1*/ 4 && img0_alt_value !== (img0_alt_value = /*hero_image_1*/ ctx[2].alt)) {
				attr(img0, "alt", img0_alt_value);
			}

			if (dirty & /*hero_image_2*/ 8 && !src_url_equal(img1.src, img1_src_value = /*hero_image_2*/ ctx[3].url)) {
				attr(img1, "src", img1_src_value);
			}

			if (dirty & /*hero_image_2*/ 8 && img1_alt_value !== (img1_alt_value = /*hero_image_2*/ ctx[3].alt)) {
