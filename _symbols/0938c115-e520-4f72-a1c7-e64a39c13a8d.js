// Contact Form - Home - Updated June 3, 2024
function noop() { }
...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty & /*social*/ 1) icon_changes.icon = /*icon*/ ctx[13];
			icon.$set(icon_changes);

			if (!current || dirty & /*social*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[12].url)) {
				attr(a, "href", a_href_value);
			}

			if (!current || dirty & /*social*/ 1 && a_alt_value !== (a_alt_value = /*link*/ ctx[12].alt)) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('content_bubble_1' in $$props) $$invalidate(2, content_bubble_1 = $$props.content_bubble_1);
		if ('content_bubble_2' in $$props) $$invalidate(3, content_bubble_2 = $$props.content_bubble_2);
		if ('form_success_title' in $$props) $$invalidate(10, form_success_title = $$props.form_success_title);
		if ('content_paragraph_1' in $$props) $$invalidate(4, content_paragraph_1 = $$props.content_paragraph_1);
		if ('content_paragraph_2' in $$props) $$invalidate(5, content_paragraph_2 = $$props.content_paragraph_2);
		if ('content_paragraph_3' in $$props) $$invalidate(6, content_paragraph_3 = $$props.content_paragraph_3);
...
class Component extends SvelteComponent {
	constructor(options) {
		...
		init(this, options, instance, create_fragment, safe_not_equal, {
			...
			content_paragraph_1: 4,
			content_paragraph_2: 5,
			content_paragraph_3: 6,
