// Site Header - Business - Updated June 3, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
// (269:10) {#each hero_feature as feature }
function create_each_block(ctx) {
	let div;
	let h6;
	let t0_value = /*feature*/ ctx[13].title + "";
	let t0;
	let t1;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*hero_feature*/ 4 && t0_value !== (t0_value = /*feature*/ ctx[13].title + "")) set_data(t0, t0_value);
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	let img_src_value;
	let img_alt_value;
	let each_value = /*hero_feature*/ ctx[2];
	let each_blocks = [];
	...
	return {
		c() {
			...
			t4 = space();
			p = element("p");
			t5 = text(/*hero_description*/ ctx[4]);
			t6 = space();
			div4 = element("div");
			img = element("img");
			this.h();
		...
		l(nodes) {
			...
			t5 = claim_text(p_nodes, /*hero_description*/ ctx[4]);
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*hero_feature*/ 4) {
				each_value = /*hero_feature*/ ctx[2];
				let i;
			...
			if (dirty & /*hero_description*/ 16) set_data(t5, /*hero_description*/ ctx[4]);
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('hero_feature' in $$props) $$invalidate(2, hero_feature = $$props.hero_feature);
		if ('hero_image_1' in $$props) $$invalidate(3, hero_image_1 = $$props.hero_image_1);
		if ('hero_image_2' in $$props) $$invalidate(8, hero_image_2 = $$props.hero_image_2);
		if ('site_nav_button' in $$props) $$invalidate(9, site_nav_button = $$props.site_nav_button);
