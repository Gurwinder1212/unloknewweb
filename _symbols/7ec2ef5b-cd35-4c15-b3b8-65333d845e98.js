// Site Header - Privacy - Updated June 3, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('hero_image' in $$props) $$invalidate(7, hero_image = $$props.hero_image);
		...
		if ('home_banner_mobile' in $$props) $$invalidate(12, home_banner_mobile = $$props.home_banner_mobile);
	};
